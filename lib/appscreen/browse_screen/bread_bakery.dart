...
class BreadBakery extends StatelessWidget {
  const BreadBakery({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
        height: MediaQuery.of(context).size.height *.15,        child:const Text('Bread & Bakery') ,
      ),
